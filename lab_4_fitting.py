...
popt, pcov = optimize.curve_fit(my_func, xdata, ydata, maxfev=200)
...
plt.errorbar(xdata,ydata,yerr=yerror,xerr=xerror,fmt=".", label = "Data points with error bars")
# plot the data, fmt makes it data points not a line
plt.plot(xs, curve, label = "Curve of best fit")
# plot the best fit curve on top of the data points as a line

plt.xlabel(xlabel, fontsize=14)
plt.ylabel(ylabel, fontsize=14)
plt.title("Log-log Relationship between length and period", fontsize = 14)
